                            ...
                            <div>
                                ...
                                <form class="flex items-center max-w-sm mx-auto">
                                    <div class="relative w-full">
                                        <div class="absolute text-gray-400 inset-y-0 start-0 flex items-center ps-3 pointer-events-none mx-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0" />
                                            </svg>
                                        </div>
                                        <input type="text" id="simple-search" class="pl-8 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search risk name..." required />
                                    </div>
                                    <button type="submit" class="p-2.5 ml-4 ms-2 p-2 text-sm font-medium text-white bg-indigo-500 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <div class="flex flex-wrap -mx-3 items-center">
                            <div class="w-full lg:w-1/2 flex items-center mb-5 lg:mb-0 px-3">
                                ...
                                <div>
                                    ...
                                    <span>
                                        <h1 class="text-4xl font-semibold inline-flex">Risk Owner</h1>
                            ...
                            <div class="w-full lg:w-auto ml-auto px-3">
                                ...
                                <a class=" items-center mt-8 py-2 px-3 text-xs text-white font-medium bg-indigo-500 hover:bg-indigo-600 rounded" href="{{ route('risks.create') }}">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4 text-right inline-flex">
                                            ...
                                            <form method="post" action="{{ route('risks.destroy', $risk->id) }}" onsubmit="return confirm('Are you sure you want to delete this risk?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline inline-flex">
                                            ...
                                            <a href="{{ route('risks.edit', $risk->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline inline-flex">
                                            ...
                                            <a href="{{ route('risks.show', $risk->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline inline-flex">
